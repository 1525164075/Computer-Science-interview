...
## [#](https://web.qianguyihao.com/13-React基础/07-React路由的使用.html#react路由的使用)React路由的使用
...
![image-20250426110812833](assets/image-20250426110812833.png)



## 匹配路由参数

### [#](https://web.qianguyihao.com/13-React基础/07-React路由的使用.html#模糊匹配与精准匹配)模糊匹配与精准匹配
