...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_2、跳转操作)2、跳转操作
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_3、移动光标)3、移动光标
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_4、编辑操作)4、编辑操作
...
另外再补充一点：将光标点击到某一行的任意位置时，默认就已经是**选中全行**了，此时可以直接**复制**或**剪切**，无需点击鼠标。这个非常实用，是所有的编辑操作中，使用得最频繁的
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_6、多光标选择-多光标编辑)6、多光标选择/多光标编辑
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_7、多列选择-多列编辑)7、多列选择/多列编辑
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_8、编程语言相关)8、编程语言相关
...
### [#](https://web.qianguyihao.com/00-前端工具/01-VS Code的使用.html#_9、搜索相关)9、搜索相关
...
### [#](https://web.qianguyihao.com/00-前端工具/02-Git的使用.html#全局配置用户信息)全局配置用户信息
...
```text
C:\Users\15251>git config --global user.name
1525164075

C:\Users\15251>git config --global user.email
1525164075@qq.com
```
